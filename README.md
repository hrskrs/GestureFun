# GestureFun [![API](https://img.shields.io/badge/API-10%2B-brightgreen.svg?style=flat-square)](https://android-arsenal.com/api?level=10)
...
```groovy
dependencies {
    compile 'com.github.hrskrs:GestureFun:v1.0.0'
}
```
